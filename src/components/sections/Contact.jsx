...
import { email, linkedinUrl, contactFormUrl } from '../../data/contact.js';
  ...
  async function submit(event) {
    ...
    try {
      ...
      setStatus({
        type: 'error',
        message:
          'Your message couldn’t be sent. Please try again or email me directly. Your draft is still here.',
      });
    } finally {
  ...
  return (
    <section id="contact" className="section container contact-section">
      <Reveal className="contact-copy">
        <p className="eyebrow">
          <span>05 /</span> GOOD THINGS START WITH A CONVERSATION
        </p>
        <h2>
          Have something
          <br />
        ...
        <p>
          A project, a possibility, or just a hello.
          <br />
        ...
        <div className="contact-links">
          ...
          <a href="tel:+97517548947">
            <FiPhone /> +975 17548947
          </a>
        </div>
        <span className="contact-location">
          <FiMapPin /> Thimphu, Bhutan
        </span>
      </Reveal>
        ...
        <form onSubmit={submit} className="contact-form">
          ...
          <label htmlFor="subject">
            ...
            <input
              id="subject"
              name="subject"
              placeholder="A project, an opportunity, a good idea…"
              maxLength={200}
            />
          </label>
