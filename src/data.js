...
export const experiences = [
        { title: 'Information Technology Officer', company: 'Bank of Bhutan, Thimphu (Onsite)', duration: 'May 2026 – Present', description: 'Responsible for managing IT infrastructure, ensuring system security, and providing technical support to optimize banking operations.', image: `${import.meta.env.BASE_URL}assets/images/BoB.png` },
        { title: 'AI Engineer', company: 'Omdena (Remote)', duration: 'May 2026 – Present', description: 'Contributing to collaborative AI projects focused on building real-world machine learning solutions. Working with cross-functional global teams to develop, deploy, and optimize AI models addressing impactful challenges in areas such as NLP, computer vision, and predictive analytics.', image: `${import.meta.env.BASE_URL}assets/images/omdena-logo.png` },
        { title: 'Project Management Unit (PMU), Department of Tourism', company: 'UNDP Bhutan (Onsite)', duration: 'Oct 2025 – Present', description: 'Supporting the Project Management Unit under the Department of Tourism in project coordination, monitoring and evaluation, documentation, and data-driven reporting. Assisting in project implementation aligned with UNDP\'s sustainable development goals and tourism sector initiatives.', image: `${import.meta.env.BASE_URL}assets/images/images.jpg` },
